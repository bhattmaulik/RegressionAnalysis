# Appendix C: How to Build This Book Locally {.unnumbered}
...
knitr::include_graphics(here::here("download-book.png"))
```
...
knitr::include_graphics(here::here("build-book.png"))
```
...
#if you want to install all the LaTeX packages, you can modify the command to tinytex::install_tinytex(bundle = "TinyTeX-2")
```
