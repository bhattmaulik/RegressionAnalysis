...
:::: status
::: callout-important 
You are reading the work-in-progress first edition of Regression Analysis with R and Easystats. This chapter is currently a dumping ground for ideas, and we don't recommend reading it. :::
::::
\end{verbatim}
